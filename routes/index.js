...
router.get('/dashboard', authMiddleware, async (req, res) => {
  ...
  // raw de hoje, mas só com quem ainda tem serviços ou produtos
    ...
    rawHoje
      .filter(a =>
        ...
        ((Array.isArray(a.services) && a.services.length) ||
         (Array.isArray(a.products) && a.products.length))
      )
      .map(a => {
